...
--
-- Table structure for table `Classroom_dimension`
--

DROP TABLE IF EXISTS `Classroom_dimension`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Classroom_dimension` (
  ...
  `cr_building_latitude` decimal(10,0) DEFAULT NULL,
  `cr_building_longitude` decimal(10,0) DEFAULT NULL,
...
-- Dump completed on 2023-06-12 11:50:17
